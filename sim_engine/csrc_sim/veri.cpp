...
int main(int argc, char **argv)
{
    ...
    printf("Area Efficiency TOPS/W for %s: %.4f TOPS/W\n", task, real_tops/cim_area*1.0e6);
    printf("Peak Energy Efficiency TOPS/W for %s: %.4f TOPS/W\n", task, peak_tops/cim_power);
