...
// //RESIZE
// #define ACCEL_REG_RESIZE_CTRL       ACCEL_REG_BASEADDR + 90*4
// #define ACCEL_REG_ORIGINAL_W        ACCEL_REG_BASEADDR + 91*4
// #define ACCEL_REG_ORIGINAL_H        ACCEL_REG_BASEADDR + 92*4
// #define ACCEL_REG_ORIGINAL_C        ACCEL_REG_BASEADDR + 93*4
// #define ACCEL_REG_RESIZE_W          ACCEL_REG_BASEADDR + 94*4
// #define ACCEL_REG_RESIZE_H          ACCEL_REG_BASEADDR + 95*4
// #define ACCEL_REG_RESIZE_C          ACCEL_REG_BASEADDR + 96*4
// #define ACCEL_REG_ORIGINAL_ADDR     ACCEL_REG_BASEADDR + 97*4
// #define ACCEL_REG_RESIZE_ADDR       ACCEL_REG_BASEADDR + 98*4
// #define ACCEL_REG_SCALE_W           ACCEL_REG_BASEADDR + 99*4
// #define ACCEL_REG_SCALE_H           ACCEL_REG_BASEADDR + 100*4
...
// #define RESIZE_RESET                Xil_Out32(ACCEL_REG_RESIZE_CTRL, 0)
// #define RESIZE_ORIGINAL_ADDR_SET(x) Xil_Out32(ACCEL_REG_ORIGINAL_ADDR, x)
// #define RESIZE_RESIZE_ADDR_SET(x)         Xil_Out32(ACCEL_REG_RESIZE_ADDR, x)
// #define RESIZE_ORIGINAL_W_SET(x)      Xil_Out32(ACCEL_REG_ORIGINAL_W, x)
// #define RESIZE_ORIGINAL_H_SET(x)     Xil_Out32(ACCEL_REG_ORIGINAL_H, x)
// #define RESIZE_ORIGINAL_C_SET(x)         Xil_Out32(ACCEL_REG_ORIGINAL_C, x)
// #define RESIZE_RESIZE_W_SET(x)      Xil_Out32(ACCEL_REG_RESIZE_W, x)
// #define RESIZE_RESIZE_H_SET(x)     Xil_Out32(ACCEL_REG_RESIZE_H, x)
// #define ACCEL_REG_RESIZE_C(x)      Xil_Out32(ACCEL_REG_RESIZE_C, x)
// #define RESIZE_SCALE_H_SET(x)      Xil_Out32(ACCEL_REG_SCALE_H, x)
// #define RESIZE_SCALE_W_SET(x)  Xil_Out32(ACCEL_REG_SCALE_W, x)
// #define RESIZE_CTRL_SET(x)     Xil_Out32(ACCEL_REG_RESIZE_CTRL, x)
